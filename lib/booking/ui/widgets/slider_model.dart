...
class SliderModel{
  ...
  static List<SliderModel> getRequiredPermissionsSlides(){
    List<SliderModel> slides = [];
    SliderModel s1 = SliderModel(AppAssets.bandVector02,
